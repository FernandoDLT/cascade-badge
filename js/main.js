...
// Your pokemon party order which is a list of pokemon has been 
// leaked to Misty. Please create a function that reverses your list 
// and prints it to the console.

function reversParty(partyList) {
    console.log( partyList.reverse() )
}
reversParty(['bulba', 'pika', 'butter', 'char'])

// Given two integer arrays a, b, both of length >= 1, create a 
// program that returns true if the sum of the squares of each 
// element in a is strictly greater than the sum of the cubes of each
// element in b.

function compareSquareAndCube(a,b) {
    return a.reduce((acc,c) => acc + c**2, 0) > b.reduce((acc,c)=> acc + c**3, 0)
}
console.log(compareSquareAndCube([4,4,4],[2,2,2]))
